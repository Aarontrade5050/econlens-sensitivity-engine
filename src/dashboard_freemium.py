...
from src.theme import C, css as _css, desc as _desc, esc as _esc, num as _num
from src.theme import kpis as _kpis, pct as _pct, tone as _tone, usd as _usd

FREEMIUM_DIR = Path(__file__).parent.parent / "resources" / "freemium"

# La paleta y los formateadores viven en src/theme.py: los comparte con el
# módulo de manifiestos, que tiene que verse igual.
